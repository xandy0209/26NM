...
export const TerminalInventoryView: React.FC = () => {
    ...
    const [newItem, setNewItem] = useState({ sn: '', deviceType: '千里眼', vendor: '' });
                                        ...
                                        <div className="flex items-center justify-center gap-3">
                                            <button 
                                                ...
                                                onClick={() => {
                                                    ...
                                                    setNewItem({ sn: item.sn, deviceType: item.deviceType, vendor: item.vendor });
                                                    setIsModalOpen(true);
                                                }}
            ...
            <div className="bg-[#1e293b]/50 border-t border-blue-500/20 flex items-center justify-between px-4 py-2 shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <StyledButton id="btn-add" variant="primary" onClick={() => {
                        setModalMode('add');
                        setEditingId(null);
                        setNewItem({ sn: '', deviceType: '千里眼', vendor: '' });
                        setIsModalOpen(true);
                            ...
                            <StyledButton variant="primary" onClick={() => {
                                if (newItem.sn) {
                                    if (modalMode === 'add') {
                                        ...
                                        setData(data.map(item => item.id === editingId ? { ...item, sn: newItem.sn, deviceType: newItem.deviceType, vendor: newItem.vendor } : item));
                                    }
